    ...
    public class EmployeeDetails
    {
        ...
        public List<EmployeeInfo> GetEmployeesDetails()
        {
            ...
            EmployeeInfoCollection.Add(new EmployeeInfo()
            {
                ...
                HireDate = Convert.ToDateTime("10/17/1994"),
                Phone = "(71) 555-7773",
                PostalCode = "RG1 9SP",
            ...
            EmployeeInfoCollection.Add(new EmployeeInfo()
            {
                ...
                HireDate = Convert.ToDateTime("8/14/1992"),
                Phone = "(206) 555-9482",
                PostalCode = "98033",
            ...
            EmployeeInfoCollection.Add(new EmployeeInfo()
            {
                ...
                HireDate = Convert.ToDateTime("10/17/1993"),
                Phone = "(71) 555-4848",
                PostalCode = "EC2 7JR",
                Title = "Sales Representative"
            });
            ...
            EmployeeInfoCollection.Add(new EmployeeInfo()
            {
                ...
                HireDate = Convert.ToDateTime("11/15/1994"),
                Phone = "(71) 555-4444",
                PostalCode = "WG2 7LT",
                Title = "Sales Representative"
            });
